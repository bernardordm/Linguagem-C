...
int main(void) {
    ...
    for(int i = 0; i < 3; i++){
        ...
        //%zu é um especificador de formato usado em Linguagem C para imprimir valores do tipo s:
        //Ele é particularmente útil quando você está trabalhando com funções que retornam valores
